...
| **0:24–0:34** | Conversation view. You type: *I have not been sleeping well for a while. Things at home are tense — my mum goes quiet whenever the past comes up and I have learned not to ask. Most days I just feel flat and a bit alone, even around my friends.* | "A user types what they have not said out loud before. Mbwira listens in the way Rwandan resilience therapy listens — not the way an American chatbot listens." | Type at human speed. Do not edit out the typing. (Classifier reads this as low — no crisis card, just a real, careful reply.) |
...
| **0:52–1:00** | You type: *Honestly I am tired of being here. I keep thinking everyone would be lighter if I just was not around anymore. I do not know how much longer I can pretend.* Send. | "And when risk rises —" | Voice trails off. Wait for the card. (Classifier reads this as high — the card mounts. Verified.) |
